...
export function Dashboard() {
  ...
  return (
    <section className="section max-h-screen trending-content mt-36 lg:mt-16 relative overflow-hidden">
      {isLoadingArticle ? (
        <ArticleLoading />
      ) : (
        <>
          <div className="text-center lg:text-left text-lg lg:text-2xl lg:mb-10 h-full">
          ...
          <div className="mt-28 lg:mt-28 mb-5">
